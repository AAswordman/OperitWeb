...
在详细介绍每个内置工具之前，先说一下怎么管理它们。

如果你想要**关闭或开启**某个内置工具，有两种方式：

1. **聊天界面菜单**：在聊天界面的菜单中找到「禁用项」，在这里可以管理工具，设置某个内置工具为关闭状态。

![工具提示词管理](</manuals/assets/tools/tool_prompt_management.jpg>)

2. **角色卡高级选项**：在角色卡编辑界面的高级选项中，可以设置**工具白名单**，精确控制该角色卡允许使用哪些工具。

![角色卡工具白名单](</manuals/assets/tools/character_card_tool_whitelist.jpg>)
