...
So the pattern is: sandbox package descriptions are hardcoded in the app, MCP descriptions are generated by the function model after startup, and Skill descriptions — you write them yourself. This is a key difference between Skill and the other two tool types.
