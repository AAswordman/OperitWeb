...
Go to the "Functional Model Configuration" screen, find the **UI Controller** option, and select or create a new configuration with a vision-enabled model, such as the `autoglm` model.
