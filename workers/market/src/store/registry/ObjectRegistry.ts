...
const OBJECTS: Record<string, { operations: Set<string>; createFields?: Set<string>; updateFields?: Set<string>; aggregateFields?: Set<string> }> = {
  ...
  Entry: { operations: new Set(['create', 'update', 'withdraw', 'approve', 'reject', 'request_changes']), createFields: fields('id type title description detail authorId publisherId allowPublicUpdates categoryId stateCode createdAt updatedAt publishedAt logoUrl'), updateFields: fields('title description detail categoryId allowPublicUpdates stateCode publishedAt logoUrl updatedAt') },
  Version: { operations: new Set(['create', 'update', 'approve', 'reject', 'request_changes']), createFields: fields('id entryId version formatVer publisherId minAppVer maxAppVer apiVersion stateCode changelog entryPatch createdAt updatedAt publishedAt runtimePkg runtimePackageId'), updateFields: fields('stateCode changelog minAppVer maxAppVer entryPatch publishedAt updatedAt') },
