...
const OBJECTS: Record<string, { operations: Set<string>; createFields?: Set<string>; updateFields?: Set<string>; aggregateFields?: Set<string> }> = {
  ...
  Version: { operations: new Set(['create', 'update', 'approve', 'reject', 'request_changes']), createFields: fields('id entryId version formatVer publisherId minAppVer maxAppVer stateCode changelog entryPatch createdAt updatedAt publishedAt runtimePkg runtimePackageId'), updateFields: fields('stateCode changelog minAppVer maxAppVer entryPatch publishedAt updatedAt') },
