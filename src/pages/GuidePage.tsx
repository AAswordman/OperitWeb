...
const GuidePage: React.FC<{ darkMode: boolean; language: 'zh' | 'en' }> = ({ darkMode, language }) => {
  ...
  const getAllDocuments = () => {
    const docs = [
      ...
      { key: 'workspace-overview', label: t.workspaceOverview, path: '/guide/development/workspace-overview', category: 'development', level: 31 },
      { key: 'web-development', label: t.webDevelopment, path: '/guide/development/web-development', category: 'development', level: 32 },
      { key: 'web-packaging', label: t.webPackaging, path: '/guide/development/web-packaging', category: 'development', level: 33 },
      { key: 'mobile-development', label: t.mobileDevelopment, path: '/guide/development/mobile-development', category: 'development', level: 34 },
      { key: 'panel-introduction', label: t.panelIntroduction, path: '/guide/interface-guide/panel-introduction', category: 'interface-guide', level: 35 },
      { key: 'return-code-generator', label: t.returnCodeGenerator, path: '/guide/tools-and-features/return-code-generator', category: 'tools-and-features', level: 36 },
      { key: 'faq', label: t.faq, path: '/guide/faq', category: 'faq', level: 37 },
    ];
    return docs;
  };
